    ...
    <section className="edit-block">
      <FormContainer extraClasses="edit-picture_form">
        ...
        <div className="edit-block_form-desc">
          ...
          <p>
            Adding a photo to your CV can be a gread way to personalize your application and make a positive first impression. When uploading your photo, make sure it is a clear and recent headshot that shows face in a profiessional manner.
          </p>
          <p>
          ...
          <p>
            When you are done, the next step is to{" "}
